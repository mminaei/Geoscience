...
uses
  ...
  TeExport, DB, DBTables, DBChart, Chart;
...
//          TempValue:=OpenedFile.Values.Fields[PHI_Track_Number].Value;
      ...
      if RHO_Track_Number>=0 then
        begin
//          TempValue:=RoundTo(OpenedFile.Values.Fields[RHO_Track_Number].Value, Precision_Value);
      ...
      if GR_Track_Number>=0 then
        begin
//          TempValue:=RoundTo(OpenedFile.Values.Fields[GR_Track_Number].Value, Precision_Value);
      ...
      if LLD_Track_Number>=0 then
        begin
//          TempValue:=RoundTo(OpenedFile.Values.Fields[LLD_Track_Number].Value, Precision_Value);
      ...
      if NPHI_Track_Number>=0 then
        begin
//          TempValue:=RoundTo(OpenedFile.Values.Fields[NPHI_Track_Number].Value, Precision_Value);
      ...
      if PEF_Track_Number>=0 then
        begin
//          TempValue:=RoundTo(OpenedFile.Values.Fields[PEF_Track_Number].Value, Precision_Value);
