...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.Ro_Track_Number:=Select_Log.Selected_Track_Number;
      Label2.Caption:=MainForm.Charts[MainForm.Ro_Track_Number].Title.Text.Text;
    end;
  Select_Log.Free;
end;
...
begin
  ...
  if MainForm.Ro_Track_Number<>-1 then
    begin
      Label2.Caption:=MainForm.Charts[MainForm.Rw_Track_Number].Title.Text.Text;
    end;
end;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.Rw_Track_Number:=Select_Log.Selected_Track_Number;
      Label4.Caption:=MainForm.Charts[MainForm.Rw_Track_Number].Title.Text.Text;
    end;
  Select_Log.Free;
end;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.PHI_Track_Number:=Select_Log.Selected_Track_Number;
      Label6.Caption:=MainForm.Charts[MainForm.PHI_Track_Number].Title.Text.Text;
    end;
  Select_Log.Free;
end;
