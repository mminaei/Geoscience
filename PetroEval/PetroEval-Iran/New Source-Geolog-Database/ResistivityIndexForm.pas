...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.Rt_Track_Number:=Select_Log.Selected_Track_Number;
      Label2.Caption:=MainForm.Charts[MainForm.Rt_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
end;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.Ro_Track_Number:=Select_Log.Selected_Track_Number;
      Label4.Caption:=MainForm.Charts[MainForm.Ro_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
end;
