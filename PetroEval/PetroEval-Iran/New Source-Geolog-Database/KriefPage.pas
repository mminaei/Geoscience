...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.DTP_Mineral_Track_Number:=Select_Log.Selected_Track_Number;
      Label2.Caption:=MainForm.Charts[MainForm.DTP_Mineral_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
end;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.DTP_Saturated_Track_Number:=Select_Log.Selected_Track_Number;
      Label4.Caption:=MainForm.Charts[MainForm.DTP_Saturated_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
end;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.DTP_Fluid_Track_Number:=Select_Log.Selected_Track_Number;
      Label6.Caption:=MainForm.Charts[MainForm.DTP_Fluid_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
end;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.DTS_Mineral_Track_Number:=Select_Log.Selected_Track_Number;
      Label8.Caption:=MainForm.Charts[MainForm.DTS_Mineral_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
end;
