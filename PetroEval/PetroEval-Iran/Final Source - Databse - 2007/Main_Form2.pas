...
uses
  ...
  TeeSVGCanvas,
  TeePSCanvas,
  TeeVMLCanvas, DB, DBTables, Chart, DBChart,
//  TeeXAMLCanvas,
  TeExport {VrGradient, VrControls,} ;
...
uses ZoomedChart, FirstForm,
     LithoMultiminForm, FluidModelForm, LithoDualForm,
     LoadForm;
