...
uses Main_Form, SelectLog, TeEngine;

{$R *.dfm}

procedure TSw_Form.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  MainForm.Sw_Calculation_Method := PageControl1.ActivePageIndex;
  MainForm.Shale_Calculation_Method := PageControl2.ActivePageIndex;
end;
...
with MainForm do
  begin
    ...
    3:begin
        CheckLog(1, RadioButton31, Edit1, 'Rw', Rw_Track_Number);
        CheckLog(2, RadioButton33, Edit2, 'Rt', Rt_Track_Number);
        CheckLog(3, RadioButton37, Edit3, 'porosity', PHI_Track_Number);
        CheckLog(4, RadioButton35, Edit4, 'shale volume', Shale_Volume_Track_Number);
        Val(LabeledEdit13.Text, Temp_Value, Error_Code);
        if (Error_Code <> 0)or(Temp_Value < 0)  then
          begin
            MessageDlg('Please enter a valid number for a!', mtWarning,[mbOk],0);
            Exit;
        ...
        Val(LabeledEdit9.Text, Temp_Value, Error_Code);
        if (Error_Code <> 0)or(Temp_Value < 0)  then
          begin
            MessageDlg('Please enter a valid number for m!', mtWarning,[mbOk],0);
            Exit;
        ...
        Val(LabeledEdit14.Text, Temp_Value, Error_Code);
        if (Error_Code <> 0)or(Temp_Value < 0)  then
          begin
            MessageDlg('Please enter a valid number for saturation exponent!', mtWarning,[mbOk],0);
            Exit;
          end
        else
          Saturation_Exponent:=Temp_Value;
...
begin
  SelectLog(MainForm.PHI_T_Track_Number, Label26);
end;
...
procedure TSw_Form.Button18Click(Sender: TObject);
begin
  SelectLog(MainForm.Rw_Track_Number, Label32);
end;

procedure TSw_Form.Button19Click(Sender: TObject);
begin
  SelectLog(MainForm.Rt_Track_Number, Label34);
end;

procedure TSw_Form.Button20Click(Sender: TObject);
begin
  SelectLog(MainForm.Shale_Volume_Track_Number, Label36);
end;

procedure TSw_Form.Button21Click(Sender: TObject);
begin
  SelectLog(MainForm.PHI_Track_Number, Label38);
end;

procedure TSw_Form.RadioButton32Click(Sender: TObject);
begin
  FromLog(True, MainForm.Rw_Track_Number, Label32, Edit17, Button18, RadioButton31, RadioButton32);
end;

procedure TSw_Form.RadioButton31Click(Sender: TObject);
begin
  FromLog(False, MainForm.Rw_Track_Number, Label32, Edit17, Button18, RadioButton31, RadioButton32);
end;

procedure TSw_Form.RadioButton34Click(Sender: TObject);
begin
  FromLog(True, MainForm.Rt_Track_Number, Label34, Edit18, Button19, RadioButton33, RadioButton34);
end;

procedure TSw_Form.RadioButton33Click(Sender: TObject);
begin
  FromLog(False, MainForm.Rt_Track_Number, Label34, Edit18, Button19, RadioButton33, RadioButton34);
end;

procedure TSw_Form.RadioButton36Click(Sender: TObject);
begin
  FromLog(True, MainForm.Shale_Volume_Track_Number, Label36, Edit19, Button20, RadioButton35, RadioButton36);
end;

procedure TSw_Form.RadioButton35Click(Sender: TObject);
begin
  FromLog(False, MainForm.Shale_Volume_Track_Number, Label36, Edit19, Button20, RadioButton35, RadioButton36);
end;

procedure TSw_Form.RadioButton38Click(Sender: TObject);
begin
  FromLog(True, MainForm.PHI_Track_Number, Label38, Edit20, Button21, RadioButton37, RadioButton38);
end;

procedure TSw_Form.RadioButton37Click(Sender: TObject);
begin
  FromLog(False, MainForm.PHI_Track_Number, Label38, Edit20, Button21, RadioButton37, RadioButton38);
end;

procedure TSw_Form.ComboBox4Change(Sender: TObject);
begin
  Case ComboBox3.ItemIndex of
    0:begin
        LabeledEdit13.Text:='1';
        LabeledEdit9.Text:='2';
      end;
    1:begin
        LabeledEdit13.Text:='1.45';
        LabeledEdit9.Text:='1.54';
      end;
    2:begin
        LabeledEdit13.Text:='1.65';
        LabeledEdit9.Text:='1.33';
      end;
    3:begin
        LabeledEdit13.Text:='1';
        LabeledEdit9.Text:='2';
    ...
    4:begin
        LabeledEdit13.Text:='0.62';
        LabeledEdit9.Text:='2.15';
      end;
    5:begin
        LabeledEdit13.Text:='0.81';
        LabeledEdit9.Text:='2';
      end;
    end;
end;
