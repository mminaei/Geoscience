...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.FR_Track_Number:=Select_Log.Selected_Track_Number;
      Label4.Caption:=MainForm.Charts[MainForm.FR_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.T_Track_Number:=Select_Log.Selected_Track_Number;
      Label8.Caption:=MainForm.Charts[MainForm.T_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.CEC_Track_Number:=Select_Log.Selected_Track_Number;
      Label6.Caption:=MainForm.Charts[MainForm.CEC_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.Rw_Track_Number:=Select_Log.Selected_Track_Number;
      Label10.Caption:=MainForm.Charts[MainForm.Rw_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.RHO_Track_Number:=Select_Log.Selected_Track_Number;
      Label14.Caption:=MainForm.Charts[MainForm.RHO_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.Rt_Track_Number:=Select_Log.Selected_Track_Number;
      Label12.Caption:=MainForm.Charts[MainForm.Rt_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
...
begin
  ...
  if Select_Log.Selected_Track_Number<>-1 then
    begin
      MainForm.n_Track_Number:=Select_Log.Selected_Track_Number;
      Label16.Caption:=MainForm.Charts[MainForm.n_Track_Number].Axes.Top.Title.Caption;
    end;
  Select_Log.Free;
    ...
    begin
      ...
      if Value_Is_Constant[1] then
        begin
          ...
          if (Error_Code=0)and(Temp_Value>=0)and(Temp_Value<=1) then
