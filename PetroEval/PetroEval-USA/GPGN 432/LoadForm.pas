...
{     with MainForm do
      ...
      ComboBox21.ItemIndex:=SP_Track_Number;
      ...
      StringGrid1.Cells[0,4]:=FloatToStr(RoundTo(DBChart9.Series[0].MinXValue, -4));
      StringGrid1.Cells[0,5]:=FloatToStr(RoundTo(DBChart9.Series[1].MinXValue, -4));
      StringGrid1.Cells[0,6]:=FloatToStr(RoundTo(DBChart9.Series[2].MinXValue, -4));
      ...
      StringGrid1.Cells[0,10]:=FloatToStr(RoundTo(DBChart1.Series[3].MinXValue, -4));
      ...
      StringGrid1.Cells[1,4]:=FloatToStr(RoundTo(DBChart9.Series[0].MaxXValue, -4));
      StringGrid1.Cells[1,5]:=FloatToStr(RoundTo(DBChart9.Series[1].MaxXValue, -4));
      StringGrid1.Cells[1,6]:=FloatToStr(RoundTo(DBChart9.Series[2].MaxXValue, -4));
      ...
      StringGrid1.Cells[1,10]:=FloatToStr(RoundTo(DBChart1.Series[3].MaxXValue, -4));
    end;
end;
      ...
      with OpenedFile do
        begin
          ...
          if MSFL_Track_Number<>-1 then
            begin
              DBChart9.Series[0].XValues.ValueSource:=Values.FieldDefs[MSFL_Track_Number].Name;
              DBChart9.Series[0].XValues.Name:=Values.FieldDefs[MSFL_Track_Number].Name;
              Properties.First;
              for i:=0 to MSFL_Track_Number-1 do
                Properties.Next;
              DBChart10.CustomAxes[0].Title.Caption :=Properties.FieldByName('TRACK_NAME').AsString + ' ('+ Properties.FieldByName('TRACK_UNIT').AsString + ')';
            end
          else
            begin
              DBChart9.Series[0].XValues.ValueSource:='';
              DBChart9.Series[0].XValues.Name:='';
              DBChart10.CustomAxes[0].Title.Caption :='[MSFL]';
            end;

          if LLM_Track_Number<>-1 then
            begin
              DBChart9.Series[1].XValues.ValueSource:=Values.FieldDefs[LLM_Track_Number].Name;
              DBChart9.Series[1].XValues.Name:=Values.FieldDefs[LLM_Track_Number].Name;
              Properties.First;
              for i:=0 to LLM_Track_Number-1 do
                Properties.Next;
              DBChart10.CustomAxes[1].Title.Caption :=Properties.FieldByName('TRACK_NAME').AsString + ' ('+ Properties.FieldByName('TRACK_UNIT').AsString + ')';
            end
          else
            begin
              DBChart9.Series[1].XValues.ValueSource:='';
              DBChart9.Series[1].XValues.Name:='';
              DBChart10.CustomAxes[1].Title.Caption :='[LLM]';
            end;
          ...
          if LLD_Track_Number<>-1 then
            begin
              ...
              for i:=0 to LLD_Track_Number-1 do
                Properties.Next;
              DBChart10.CustomAxes[2].Title.Caption :=Properties.FieldByName('TRACK_NAME').AsString + ' ('+ Properties.FieldByName('TRACK_UNIT').AsString + ')';
            end
          else
            begin
              DBChart9.Series[2].XValues.ValueSource:='';
              DBChart9.Series[2].XValues.Name:='';
              DBChart10.CustomAxes[2].Title.Caption :='[LLD]';
            end;
          ...
          if DPHI_Track_Number<>-1 then
            begin
              DBChart4.Series[2].XValues.ValueSource:=Values.FieldDefs[DPHI_Track_Number].Name;
              DBChart4.Series[2].XValues.Name:=Values.FieldDefs[DPHI_Track_Number].Name;
              Properties.First;
              for i:=0 to DPHI_Track_Number-1 do
                Properties.Next;
            ...
            begin
              ...
              DBChart8.CustomAxes[2].Title.Caption :='[DPHI]';
            end;
...
{   with MainForm do
  ...
  with MainForm2 do
    begin
      ...
      SP_Track_Number:=ComboBox21.ItemIndex;
      ...
      with OpenedFile do
        begin
          ...
          if LLD_Track_Number<>-1 then
            begin
              DBChart9.Series[2].XValues.ValueSource:=Values.FieldDefs[LLD_Track_Number].Name;
              DBChart9.Series[2].XValues.Name:=Values.FieldDefs[LLD_Track_Number].Name;
              Properties.First;
              for i:=0 to LLD_Track_Number-1 do
                Properties.Next;
              DBChart10.CustomAxes[2].Title.Caption :=Properties.FieldByName('TRACK_NAME').AsString + ' ('+ Properties.FieldByName('TRACK_UNIT').AsString + ')';
...
begin
      ...
      if MainForm2.MSFL_Track_Number<>-1 then
        begin
          MainForm2.DBChart9.Series[0].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.MSFL_Track_Number].Name;
          MainForm2.DBChart9.Series[0].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.MSFL_Track_Number].Name;
          StringGrid1.Cells[0,4]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[0].MinXValue, -4));
          StringGrid1.Cells[1,4]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[0].MaxXValue, -4));
        end
      else
        begin
...
begin
      ...
      if MainForm2.LLM_Track_Number<>-1 then
        begin
          MainForm2.DBChart9.Series[1].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.LLM_Track_Number].Name;
          MainForm2.DBChart9.Series[1].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.LLM_Track_Number].Name;
          StringGrid1.Cells[0,5]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[1].MinXValue, -4));
          StringGrid1.Cells[1,5]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[1].MaxXValue, -4));
        end
      else
        begin
...
begin
      ...
      if MainForm2.LLD_Track_Number<>-1 then
        begin
          MainForm2.DBChart9.Series[2].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.LLD_Track_Number].Name;
          MainForm2.DBChart9.Series[2].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.LLD_Track_Number].Name;
          StringGrid1.Cells[0,6]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[2].MinXValue, -4));
          StringGrid1.Cells[1,6]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[2].MaxXValue, -4));
        end
      else
        begin
...
//     ChangePath;
     with OpenedFile do
      begin
        ...
        DepthUnitString:=Uppercase(Edit4.Text);
...
{     with MainForm do
      ...
      ComboBox20.ItemIndex:=SP_Track_Number;
      ...
      StringGrid2.Cells[0,4]:=FloatToStr(RoundTo(DBChart9.Series[0].MinXValue, -4));
      StringGrid2.Cells[0,5]:=FloatToStr(RoundTo(DBChart9.Series[1].MinXValue, -4));
      StringGrid2.Cells[0,6]:=FloatToStr(RoundTo(DBChart9.Series[2].MinXValue, -4));
      ...
      StringGrid2.Cells[0,10]:=FloatToStr(RoundTo(DBChart1.Series[3].MinXValue, -4));
      ...
      StringGrid2.Cells[1,4]:=FloatToStr(RoundTo(DBChart9.Series[0].MaxXValue, -4));
      StringGrid2.Cells[1,5]:=FloatToStr(RoundTo(DBChart9.Series[1].MaxXValue, -4));
      StringGrid2.Cells[1,6]:=FloatToStr(RoundTo(DBChart9.Series[2].MaxXValue, -4));
      ...
      StringGrid2.Cells[1,10]:=FloatToStr(RoundTo(DBChart1.Series[3].MaxXValue, -4));
    end;
finally
  Database_Opened:=True;
end;
...
begin
      ...
      if MainForm2.MSFL_Track_Number<>-1 then
        begin
          MainForm2.DBChart9.Series[0].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.MSFL_Track_Number].Name;
          MainForm2.DBChart9.Series[0].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.MSFL_Track_Number].Name;
          StringGrid2.Cells[0,4]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[0].MinXValue, -4));
          StringGrid2.Cells[1,4]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[0].MaxXValue, -4));
        end
      else
        begin
...
begin
      ...
      if MainForm2.LLM_Track_Number<>-1 then
        begin
          MainForm2.DBChart9.Series[1].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.LLM_Track_Number].Name;
          MainForm2.DBChart9.Series[1].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.LLM_Track_Number].Name;
          StringGrid2.Cells[0,5]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[1].MinXValue, -4));
          StringGrid2.Cells[1,5]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[1].MaxXValue, -4));
        end
      else
        begin
...
begin
      ...
      if MainForm2.LLD_Track_Number<>-1 then
        begin
          MainForm2.DBChart9.Series[2].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.LLD_Track_Number].Name;
          MainForm2.DBChart9.Series[2].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.LLD_Track_Number].Name;
          StringGrid2.Cells[0,6]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[2].MinXValue, -4));
          StringGrid2.Cells[1,6]:=FloatToStr(RoundTo(MainForm2.DBChart9.Series[2].MaxXValue, -4));
        end
      else
        begin
...
with MainForm2 do
  begin
    ...
    DBChart1.Series[3].YValues.ValueSource:='';
    DBChart1.Series[3].XValues.ValueSource:='';
    DBChart1.Series[3].DataSource:=nil;
...
begin
      MainForm2.SP_Track_Number:=ComboBox20.ItemIndex;
      if MainForm2.SP_Track_Number<>-1 then
        begin
          MainForm2.DBChart1.Series[3].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.SP_Track_Number].Name;
          MainForm2.DBChart1.Series[3].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.SP_Track_Number].Name;
          StringGrid2.Cells[0,10]:=FloatToStr(RoundTo(MainForm2.DBChart1.Series[3].MinXValue, -4));
          StringGrid2.Cells[1,10]:=FloatToStr(RoundTo(MainForm2.DBChart1.Series[3].MaxXValue, -4));
        end
      else
        begin
...
begin
      MainForm2.Sp_Track_Number:=ComboBox21.ItemIndex;
      if MainForm2.SP_Track_Number<>-1 then
        begin
          MainForm2.DBChart1.Series[3].XValues.ValueSource:=OpenedFile.Values.FieldDefs[MainForm2.SP_Track_Number].Name;
          MainForm2.DBChart1.Series[3].XValues.Name:=OpenedFile.Values.FieldDefs[MainForm2.SP_Track_Number].Name;
          StringGrid1.Cells[0,11]:=FloatToStr(RoundTo(MainForm2.DBChart1.Series[3].MinXValue, -4));
          StringGrid1.Cells[1,11]:=FloatToStr(RoundTo(MainForm2.DBChart1.Series[3].MaxXValue, -4));
        end
      else
        begin
          StringGrid1.Cells[0,11]:='0';
