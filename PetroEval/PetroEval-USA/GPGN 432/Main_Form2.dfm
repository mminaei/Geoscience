  ...
  object Panel1: TPanel
    ...
    object ScrollBox1: TScrollBox
      ...
      object DBChart9: TDBChart
        ...
        Title.Text.Strings = (
          'TDBChart')
        Title.Visible = False
        OnScroll = DBChart9Scroll
        OnUndoZoom = DBChart9UndoZoom
        OnZoom = Zooming
        CustomAxes = <
          item
            Automatic = False
        ...
        Color = clWhite
        TabOrder = 4
        OnDblClick = DBChart9DblClick
        OnDragDrop = ChartsDragDrop
        OnDragOver = ChartsDragOver
        object HorizLineSeries4: THorizLineSeries
          HorizAxis = aCustomHorizAxis
          Marks.Arrow.Visible = True
          Marks.Callout.Brush.Color = clBlack
          Marks.Callout.Arrow.Visible = True
        ...
        object HorizLineSeries5: THorizLineSeries
          HorizAxis = aCustomHorizAxis
          Marks.Arrow.Visible = True
          Marks.Callout.Brush.Color = clBlack
          Marks.Callout.Arrow.Visible = True
        ...
        object HorizLineSeries6: THorizLineSeries
          HorizAxis = aCustomHorizAxis
          Marks.Arrow.Visible = True
          Marks.Callout.Brush.Color = clBlack
          Marks.Callout.Arrow.Visible = True
        ...
        object MarksTipTool1: TMarksTipTool
          HideDelay = 3500
          MouseAction = mtmClick
          MouseDelay = 0
          Style = smsXY
    ...
    object ScrollBox2: TScrollBox
      ...
      object DBChart10: TDBChart
        ...
        Color = clWhite
        TabOrder = 4
        OnDblClick = DBChart10DblClick
        object HorizLineSeries7: THorizLineSeries
          HorizAxis = aCustomHorizAxis
          Marks.Arrow.Visible = True
          Marks.Callout.Brush.Color = clBlack
          Marks.Callout.Arrow.Visible = True
        ...
        object HorizLineSeries8: THorizLineSeries
          HorizAxis = aCustomHorizAxis
          Marks.Arrow.Visible = True
          Marks.Callout.Brush.Color = clBlack
          Marks.Callout.Arrow.Visible = True
        ...
        object HorizLineSeries9: THorizLineSeries
          HorizAxis = aCustomHorizAxis
          Marks.Arrow.Visible = True
          Marks.Callout.Brush.Color = clBlack
          Marks.Callout.Arrow.Visible = True
